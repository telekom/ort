...
class DefaultProvenanceTreeResolverFunTest : WordSpec() {
    private val resolver = DefaultProvenanceTreeResolver()
    ...
    init {
        "Resolving an artifact provenance" should {
            "Return only the artifact provenance" {
                ...
                resolver.resolveProvenanceTree(provenance) shouldBe
                        ProvenanceTree(root = provenance, subRepositories = emptyMap())
            }
        }
        ...
        "Resolving a repository provenance" should {
            ...
            "Find recursive Git submodules" {
                ...
                val tree = resolver.resolveProvenanceTree(provenance)

                tree.root shouldBe provenance
                tree.subRepositories should containExactly(
            ...
            "Find Git-Repo projects with recursive Git submodules" {
                val provenance = RepositoryProvenance(
                    vcsInfo = VcsInfo(
